 <x-app-layout>
     ...
     <x-slot name="header">
        ...
        inline-block py-3 
    header-font text-center mx-auto dark:text-white  cursor-default">Add Product-variant</h2>
         ...
         <div class=" bg-white dark:bg-secondary-700 rounded-md flex justify-center">
             <div class="w-full  lg:w-full h-full p-8">
                 ...
                 <form method="POST" class="mt-4 flex flex-col items-center" enctype="multipart/form-data"
                     action="{{ route('admin.product-variant.store',$product) }}">
                     @csrf
                     @include('admin.variants.partials.form')
